...
pub const COLOR_BACKGROUND: Color = Color::oklch(0.18, 0.003, 245.0);
pub const COLOR_SURFACE: Color = Color::oklch(0.24, 0.004, 245.0);
pub const COLOR_SURFACE_RAISED: Color = Color::oklch(0.31, 0.006, 245.0);
pub const COLOR_BORDER: Color = Color::oklch(0.40, 0.008, 245.0);
